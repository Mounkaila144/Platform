...
class PanierController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_panier_new', methods: ['GET', 'POST','PUT'])]
    ...
    public function show(Commande $commande,Users $client): Response
    {
    ...
    #[Route('/{id}/edit', name: 'app_panier_edit', methods: ['GET', 'POST','PUT'])]
